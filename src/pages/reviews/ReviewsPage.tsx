...
const mockReviews: Review[] = [
  {
    ...
    clientAvatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b647?w=40&h=40&fit=crop&crop=face',
    artisanId: 'artisan1',
    artisanName: 'Michael Chen',
    artisanAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face',
    rating: 5,
    comment: 'Absolutely incredible work! Michael transformed my living room into a masterpiece. His attention to detail and creativity exceeded all expectations. The project was completed on time and within budget.',
    projectType: 'Interior Design',
    projectTitle: 'Modern Living Room Makeover',
    date: '2024-01-15',
    response: 'Thank you so much, Sarah! It was a pleasure working on your living room. I\'m thrilled you love the final result!',
  ...
  },
  {
    ...
    artisanAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face',
    rating: 4,
    comment: 'Great communication and professional work. The kitchen renovation looks amazing. Only minor delay in delivery but overall very satisfied.',
    projectType: 'Kitchen Renovation',
    projectTitle: 'Modern Kitchen Remodel',
    date: '2024-01-10',
    images: ['https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=150&fit=crop'],
    helpful: 8,
    verified: true,
    type: 'received'
  },
  {
    ...
    artisanAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=40&h=40&fit=crop&crop=face',
    rating: 5,
    comment: 'Lisa created the most beautiful custom furniture for my home office. Her craftsmanship is exceptional and she really understood my vision.',
  ...
  },
  {
    ...
    artisanAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face',
    rating: 3,
    comment: 'Decent work but took longer than expected. The final result was good but communication could have been better throughout the project.',
...
export const ReviewsPage: React.FC = () => {
  ...
  const filteredReviews = useMemo(() => {
    return mockReviews.filter(review => {
      ...
      if (selectedProjectType && review.projectType !== selectedProjectType) return false;
  ...
  const ratingDistribution: RatingDistribution = receivedReviews.reduce((acc, review) => {
    acc[review.rating] = (acc[review.rating] || 0) + 1;
    return acc;
  }, {} as RatingDistribution);

  const projectTypes = Array.from(new Set(mockReviews.map(r => r.projectType)));
      ...
      <Card className="p-6 hover:shadow-lg transition-all duration-300">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-start space-x-4">
            <img
              src={activeTab === 'received' ? review.clientAvatar : review.artisanAvatar}
              alt="Profile"
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2 mb-1">
                <h4 className="font-semibold text-gray-900">
                  {activeTab === 'received' ? review.clientName : review.artisanName}
                </h4>
                {review.verified && (
              ...
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="text-sm text-gray-500">{review.projectType}</span>
        ...
        <div className="mb-4">
          <h5 className="font-medium text-gray-900 mb-2">{review.projectTitle}</h5>
        ...
        {review.response && (
          <div className="bg-gray-50 rounded-lg p-4 mt-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-900">Response from Artisan</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <Card className="p-6 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900">{receivedReviews.length}</h3>
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={clsx(
                      ...
                      selectedRating === null ? 'bg-purple-100 text-purple-700' : 'hover:bg-gray-50'
                    )}
                  >
                    All Ratings
                  </button>
                  {[5, 4, 3, 2, 1].map((rating) => (
                    <button
                      ...
                      className={clsx(
                        ...
                        selectedRating === rating ? 'bg-purple-100 text-purple-700' : 'hover:bg-gray-50'
                      )}
                    >
              ...
              <div className="mb-4">
                ...
                <div className="space-y-1">
                  <button
                    ...
                    className={clsx(
                      'w-full text-left px-3 py-2 rounded-lg text-sm transition-colors',
                      selectedProjectType === null ? 'bg-purple-100 text-purple-700' : 'hover:bg-gray-50'
                    )}
                  >
                    All Types
                  </button>
                  {projectTypes.map((type) => (
                    <button
                      ...
                      className={clsx(
                        'w-full text-left px-3 py-2 rounded-lg text-sm transition-colors',
                        selectedProjectType === type ? 'bg-purple-100 text-purple-700' : 'hover:bg-gray-50'
                      )}
                    >
                      {type}
                    </button>
