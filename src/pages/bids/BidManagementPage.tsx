      ...
      <div className="max-w-7xl mx-auto px-4 mt-16 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedStatus(e.target.value as BidStatus)
                  }
        ...
        {filteredAndSortedBids.length === 0 ? (
          <GlassmorphicCard className="p-12 text-center" opacity={0.2}>
            ...
            <NeonButton variant="primary" onClick={() => navigate("/jobs")}>
              Browse Jobs
            </NeonButton>
          </GlassmorphicCard>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {bid.proposal.timeline.milestones &&
                      bid.proposal.timeline.milestones.length > 0 && (
                        <div className="mb-4">
                          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
                            <Clock className="w-4 h-4" />
                            <span>
                              {bid.proposal.timeline.milestones.length}{" "}
                              milestones planned
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <NeonButton
                          ...
                          size="sm"
                          onClick={() =>
                            navigate(`/chat?project=${bid.job.id}`)
                          }
                        >
                        ...
                        >
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <p className="text-sm font-medium text-blue-800">
                              Negotiation History (
                              {bid.negotiationHistory.length} messages)
                            </p>
                          </div>
        ...
        {filteredAndSortedBids.length >= 10 && (
          <div className="mt-8 text-center">
            <NeonButton variant="secondary">Load More Proposals</NeonButton>
          </div>
        )}
      </div>
    </div>
