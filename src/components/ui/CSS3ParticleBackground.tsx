...
export const CSS3ParticleBackground: React.FC = () => {
    ...
    const createParticles = () => {
      ...
      for (let i = 0; i < particleCount; i++) {
        particles.push({
          ...
          color: Math.random() > 0.7 ? '#FFC107' : '#9945FF'
        });
      }
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/2 w-12 h-12 bg-gradient-to-br from-yellow-400/20 to-purple-600/20 rounded-lg backdrop-blur-sm"
        animate={{
          rotate: [0, 360],
          scale: [1, 1.1, 1],
        }}
